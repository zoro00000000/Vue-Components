  ...
  if (type === 'vue') {
          ...
          <ul class={`${prefixCls}-paragraph-container`}>
            {
              newArray.map((item, index) => {
                return <li class={active ? 'skeleton-animate' : 'skeleton-color'} key={index} style={getWidth({
                  index,
                  width,
                  rows
                })}/>
    ...
    return (
      <ul className={`${prefixCls}-paragraph-container`}>
        {
          newArray.map((item, index) => {
            return <li className={active ? 'skeleton-animate' : 'skeleton-color'} key={index} style={getWidth({
              index,
              width,
              rows
            })}/>
