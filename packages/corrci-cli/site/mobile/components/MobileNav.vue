<template>
  <div v-show="title" class="corrci-mobile-nav">
    <div class="corrci-mobile-nav__title">{{ title }}</div>
    <svg class="corrci-mobile-nav__back" viewBox="0 0 1000 1000" @click="onBack">
